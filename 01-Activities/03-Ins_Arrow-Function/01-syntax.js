...
// If the arrow function body contains only one expression, 
  // we can omit the curly braces and auto return it
var createGreeting = (message, name) => message + ", " + name + "!";

// If an arrow function only has one parameter, 
  // we can omit the parens () around the single parameter
